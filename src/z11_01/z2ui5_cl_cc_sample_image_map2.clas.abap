CLASS z2ui5_cl_cc_sample_image_map2 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS Z2UI5_CL_CC_SAMPLE_IMAGE_MAP2 IMPLEMENTATION.
  ...
  METHOD z2ui5_on_event.
    ...
    CASE client->get( )-event.
      WHEN 'GO_TO_EDITOR'.
        client->nav_app_call( NEW z2ui5_cl_cc_sample_image_maP( b64_image = mv_value filename = mv_path ) ).
      WHEN 'START'.
        z2ui5_on_rendering( client ).
      WHEN 'BACK'.
